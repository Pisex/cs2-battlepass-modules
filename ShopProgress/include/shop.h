...
public:
	...
	virtual void GiveClientCurrency_Offline(const char* szSteamID, int iAmount, const char* szCurrency) = 0;
	virtual void TakeClientCurrency_Offline(const char* szSteamID, int iAmount, const char* szCurrency) = 0;
	virtual void GiveClientItem_Offline(const char* szSteamID, const char* szItem, const char* szCategory, int iCount) = 0;
	virtual void TakeClientItem_Offline(const char* szSteamID, const char* szItem, const char* szCategory, int iCount) = 0;
	virtual bool SetClientCookie(int iSlot, const char* szCookie, const char* szValue) = 0;
	virtual const char* GetClientCookie(int iSlot, const char* szCookie) = 0;
};